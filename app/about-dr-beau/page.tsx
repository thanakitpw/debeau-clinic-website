...
import { CheckCircle, Award, GraduationCap, Briefcase, ArrowRight, ImageIcon } from "lucide-react";
    ...
    <>
      ...
      >
        ...
        <div className="max-w-5xl mx-auto relative z-10 grid lg:grid-cols-2 gap-12 items-center">
          ...
          {/* Doctor photo placeholder + Stats */}
          <div className="flex flex-col gap-4">
            <div
              className="w-full rounded-2xl flex flex-col items-center justify-center gap-3 border-2 border-dashed"
              style={{ minHeight: "240px", borderColor: "rgba(195,135,137,0.35)", backgroundColor: "rgba(255,255,255,0.05)" }}
            >
              <ImageIcon size={32} style={{ color: "rgba(195,135,137,0.5)" }} />
              <p className="text-xs font-light" style={{ color: "rgba(255,255,255,0.4)" }}>ใส่รูปหมอโบ</p>
            </div>
            <div className="grid grid-cols-2 gap-3">
              {[
                ...
                <div key={i} className="p-4 rounded-2xl text-center"
                  ...
                  <div className="text-2xl font-light mb-1" style={{ color: "#c38789" }}>{s.value}</div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-5 max-w-3xl mx-auto">
            {experience.map((item, i) => (
              <div key={i} className="p-6 rounded-2xl flex gap-4"
      ...
      <section className="py-20 px-6" style={{ backgroundColor: "#fff" }}>
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="section-title">อบรมเพิ่มเติม</h2>
            <div className="divider-rose mt-4" />
          </div>
      ...
      <section className="py-20 px-6" style={{ backgroundColor: "#69554a" }}>
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            <p className="text-xs tracking-[0.3em] uppercase font-medium mb-3" style={{ color: "#c38789" }}>
              Recognition
            </p>
            <h2 className="text-3xl font-light tracking-wide" style={{ color: "#fff" }}>รางวัลและความสำเร็จ</h2>
            <div className="w-14 h-0.5 mx-auto mt-4"
              style={{ background: "linear-gradient(to right, #c38789, #8b7f7c)" }} />
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {awards.map((award, i) => (
              <div key={i} className="p-6 rounded-2xl flex flex-col gap-3 text-center"
                style={{ backgroundColor: "rgba(255,255,255,0.07)" }}>
      ...
      <section className="py-20 px-6 text-center" style={{ backgroundColor: "#e8e7e5" }}>
        <div className="max-w-xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Link href="/customer-reviews" className="btn-outline">ดูรีวิวลูกค้า</Link>
          </div>
        </div>
      </section>
