...
export const metadata: Metadata = {
  title: "บทความความงาม | DE BEAU CLINIC",
  description:
    "บทความความรู้ด้านความงามและเวชศาสตร์ความงาม จากแพทย์ผู้เชี่ยวชาญ De Beau Clinic",
};

const categories = ["ทั้งหมด", "ฟิลเลอร์", "ความรู้ทั่วไป", "Ulthera", "Botox", "Laser"];
          ...
          <div className="max-w-5xl mx-auto flex gap-2 overflow-x-auto pb-1 scrollbar-hide">
            {categories.map((cat) => (
              <button
                ...
                style={{
                  backgroundColor: cat === "ทั้งหมด" ? "#c38789" : "#e8e7e5",
                  color: cat === "ทั้งหมด" ? "#fff" : "#69554a",
                }}
              >
                {cat}
              </button>
        ...
        <section className="py-16 px-6" style={{ backgroundColor: "#fff" }}>
          <div className="max-w-5xl mx-auto">
            ...
            <Link href={`/blog/${featured.slug}`} className="group block">
              <div
                className="rounded-3xl overflow-hidden grid lg:grid-cols-2 gap-0 transition-all duration-300 hover:shadow-xl"
        ...
        <section className="pb-20 px-6" style={{ backgroundColor: "#fff" }}>
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div
                className="flex flex-col items-center justify-center gap-3 rounded-2xl p-8 border-2 border-dashed"
                style={{ borderColor: "#e0ddd9", backgroundColor: "#f9f8f7", minHeight: "280px" }}
              >
