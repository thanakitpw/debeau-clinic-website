      ...
      <main>
        ...
        >
          <div className="max-w-3xl mx-auto">
            ...
            <div
              className="w-full rounded-t-3xl flex flex-col items-center justify-center gap-4 overflow-hidden"
              style={{
                minHeight: "300px",
        ...
        <section className="py-16 px-6" style={{ backgroundColor: "#fff" }}>
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex flex-col gap-12">
              {post.content.sections.map((section, i) => (
                <div key={i} className="flex flex-col gap-4">
                  ...
                  {i === 1 && (
                    <div
                      className="w-full rounded-2xl flex flex-col items-center justify-center gap-2 border-2 border-dashed mb-2"
            ...
            {/* Conclusion */}
            <div
              className="mt-12 p-7 rounded-2xl flex flex-col gap-3"
            ...
            {/* CTA */}
            <div
              className="mt-10 rounded-3xl p-8 flex flex-col items-center text-center gap-4"
            ...
            >
              ...
              <a
                ...
                className="flex items-center gap-2 px-6 py-3 rounded-full text-sm font-medium transition-opacity hover:opacity-90"
