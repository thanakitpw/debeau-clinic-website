    ...
    <>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {channels.map((ch, i) => {
              ...
              const content = (
                <div
                  className={`flex flex-col gap-4 p-7 rounded-2xl transition-all duration-300 h-full ${ch.href ? "hover:-translate-y-1 hover:shadow-lg" : ""}`}
                ...
                >
                  ...
                  <div>
                    <p className="text-xs tracking-widest uppercase font-medium mb-1" style={{ color: "#8b7f7c" }}>
                      {ch.label}
                    </p>
      ...
      <section className="py-16 px-6" style={{ backgroundColor: "#e8e7e5" }}>
        <div className="max-w-3xl mx-auto p-10 rounded-3xl text-center"
          ...
          <a href="https://line.me/R/ti/p/@debeauclinic" target="_blank" rel="noopener noreferrer"
            className="inline-flex items-center gap-3 px-8 py-3.5 rounded-full text-base font-medium transition-all duration-300 hover:opacity-90"
      ...
      <section className="py-20 px-6" style={{ backgroundColor: "#fff" }}>
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex flex-col gap-4">
            {faqs.map((faq, i) => (
              <div key={i} className="p-6 rounded-2xl" style={{ backgroundColor: "#e8e7e5" }}>
      ...
      <section className="py-16 px-6" style={{ backgroundColor: "#e8e7e5" }}>
        <div className="max-w-5xl mx-auto text-center">
          <p className="text-sm tracking-widest uppercase mb-6" style={{ color: "#8b7f7c" }}>บริการของเรา</p>
          <div className="flex flex-wrap justify-center gap-3">
            {[
              ...
              <Link key={s.href} href={s.href}
                className="px-5 py-2.5 rounded-full text-sm font-medium transition-all duration-200 hover:-translate-y-0.5 hover:shadow-sm"
